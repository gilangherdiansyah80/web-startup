  ...
  return (
    <Fragment>
      <article className="flex flex-col gap-y-3 xl:self-center xl:w-3/5 mt-8">
        <h1 className="text-2xl font-bold text-purple-800 md:text-4xl">
        ...
        <article className="flex flex-col gap-y-3 md:grid md:grid-cols-3 md:gap-3">
          <div className="flex flex-col gap-y-3">
            <h2 className="text-xl md:text-2xl font-semibold">
              Pembuatan <span className="text-purple-800">Website</span>{" "}
            ...
            <a
              ...
              className="flex items-center self-start justify-center gap-x-2 text-purple-800"
            >
          ...
          <div className="flex flex-col gap-y-3">
            <h2 className="text-xl font-semibold md:text-2xl">
              IT <span className="text-purple-800">Konsultan</span>{" "}
            ...
            <div key={item.id} className="flex flex-col gap-y-3">
              ...
              <div className="flex justify-between items-center">
                ...
                <a
                  href={item.url}
                  target="_blank"
                  className="border-black border-2 rounded-lg flex justify-center w-10 h-6 p-3 hover:bg-purple-800 group border-solid items-center"
                >
