                ...
                <section className="flex flex-col gap-y-5 justify-center xl:self-center xl:w-3/5">
                    ...
                    <article className="flex flex-col gap-y-3 md:grid md:grid-cols-3 md:gap-3">
                        <div className="flex flex-col gap-y-3">
                            <h2 className="text-xl md:text-2xl font-semibold">Pembuatan <span className="text-purple-800">Website</span> <span className="block">Menggunakan Template</span></h2>
                        ...
                        <div className="flex flex-col gap-y-3">
                            <h2 className="text-xl font-semibold md:text-2xl">Pembuatan <span className="text-purple-800">Website</span> <span className="block">Menggunakan Design anda</span></h2>
                        ...
                        <div className="flex flex-col gap-y-3">
                            <h2 className="text-xl font-semibold md:text-2xl">IT <span className="text-purple-800">Konsultan</span> <span className="block">Menyediakan Layanan IT yang Inovatif</span></h2>
                ...
                <section className="flex flex-col gap-y-10 xl:self-center xl:w-3/5">
                    ...
                    <section className="flex flex-col gap-y-3 justify-center items-center md:flex-row md:grid md:grid-cols-3 md:gap-3 md:items-start">
                        <div className="flex flex-col justify-center items-center gap-y-3">
                            <div className="bg-[url('./images/border3.png')] bg-cover bg-center bg-no-repeat p-5 flex justify-center items-center">
                            ...
                            <div key={item.id} className="flex flex-col gap-y-3">
                                ...
                                <div className="flex justify-between items-center">
                                    <h1 className="font-semibold">{item.name}</h1>
                                        <a href={item.url} target="_blank" className="border-black border-2 rounded-lg flex justify-center w-10 h-6 p-3 hover:bg-purple-800 group border-solid items-center">
